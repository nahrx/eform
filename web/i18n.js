...
(function () {
  ...
  const DICT_ID = {
    ...
    "inline": "inline",
    " or ": " atau ",
    "Each table lists its options inline under ": "Tiap tabel memuat pilihannya langsung di dalam ",
    ", every entry a ": ", tiap entri berisi ",
    " and a ": " dan ",
    ". Add ": ". Tambahkan ",
    " to an entry to make the table cascade from another field. Reference a table from a field using ": " pada sebuah entri agar tabelnya bertingkat mengikuti field lain. Rujuk sebuah tabel dari field lewat ",
    ". To pull options from an external service instead, set the field's choice source to ": ". Untuk menarik pilihan dari layanan luar, atur sumber pilihan field itu ke ",
    ...
    "Shared with me": "Dibagikan ke saya",
    "Forms owned by another admin where you were given viewer or editor access": "Kuesioner milik admin lain yang aksesnya diberikan kepada Anda sebagai viewer atau editor",
    "Access": "Akses",
    "Scope": "Cakupan",
    "View responses →": "Lihat jawaban →",
    "Selected respondents": "Responden terpilih",
    "All respondents · all fields": "Semua responden · semua variabel",
    "Selected respondents · all fields": "Responden terpilih · semua variabel",
    "Title": "Judul",
    "Responses": "Jawaban",
    ...
    "Delete this draft": "Hapus draf ini",
    "Delete this draft?": "Hapus draf ini?",
    "Every answer filled in for this response is discarded. This cannot be undone.": "Semua jawaban pada respons ini akan dibuang. Tindakan ini tidak dapat dibatalkan.",
    "Delete draft": "Hapus draf",
    "The numbers do not match.": "Angkanya tidak cocok.",
    "No connection — the draft can only be deleted online.": "Tidak ada koneksi — draf hanya bisa dihapus saat online.",
    ...
    "⚠ Offline — showing what is stored on this device. The list refreshes once you are back online.": "⚠ Offline — menampilkan yang tersimpan di perangkat ini. Daftar diperbarui begitu kembali online.",
    "Done": "Selesai",
